      ...
      if (poste && entreprise) {
        ...
        experienceList.innerHTML = `
                <div class="flex justify-between">
                    ...
                    <div>
                        <button class="modify-experience text-blue-500 hover:text-blue-700" data-index="${
      ...
      if (diplome && ecole) {
        ...
        formationList.innerHTML = `
                <div class="flex justify-between">
                    ...
                    <div>
                        <button class="modify-formation text-blue-500 hover:text-blue-700" data-index="${
    ...
    .addEventListener("click", function () {
      ...
      if (skill) {
        ...
        skillList.innerHTML = `
                <span>${skill}</span>
                <div>
                    <button class="modify-skill text-blue-500 hover:text-blue-700" data-index="${
      ...
      if (nom && entreprise) {
        ...
        referenceList.innerHTML = `
                <div class="flex justify-between">
                    ...
                    <div>
                        <button class="modify-reference text-blue-500 hover:text-blue-700" data-index="${
    ...
    .addEventListener("click", function () {
      ...
      if (langue && niveau) {
        ...
        languageList.innerHTML = `
                ...
                <div>
                    <button class="modify-language text-blue-500 hover:text-blue-700" data-index="${
    ...
    cvData.experiences.forEach((experience, index) => {
      ...
      experienceList.innerHTML = `
          <div class="flex justify-between">
            ...
            <div>
              <button class="modify-experience text-blue-500 hover:text-blue-700" data-index="${index}">
                <i class="fas fa-edit"></i>
              </button>
    ...
    cvData.formations.forEach((formation, index) => {
      ...
      formationList.innerHTML = `
          <div class="flex justify-between">
            ...
            <div>
              <button class="modify-formation text-blue-500 hover:text-blue-700" data-index="${index}">
                <i class="fas fa-edit"></i>
              </button>
  ...
  function updateSkillFields() {
    cvData.competences.forEach((skill, index) => {
      ...
      skillList.innerHTML = `
          <span>${skill}</span>
          <div>
            <button class="modify-skill text-blue-500 hover:text-blue-700" data-index="${index}">
              <i class="fas fa-edit"></i>
            </button>
    ...
    cvData.references.forEach((reference, index) => {
      ...
      referenceList.innerHTML = `
          <div class="flex justify-between">
            ...
            <div>
              <button class="modify-reference text-blue-500 hover:text-blue-700" data-index="${index}">
                <i class="fas fa-edit"></i>
              </button>
  ...
  function updateLanguageFields() {
    cvData.langues.forEach((langue, index) => {
      ...
      languageList.innerHTML = `
          <span>${langue}</span>
          <div>
            <button class="modify-language text-blue-500 hover:text-blue-700" data-index="${index}">
              <i class="fas fa-edit"></i>
            </button>
